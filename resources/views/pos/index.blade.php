...
@section('products-grid')
    ...
    <div class="bg-white rounded-lg shadow p-4 cursor-pointer hover:shadow-lg transition-shadow product-item"
        ...
        <div class="flex justify-between items-center mt-1">
            ...
            <span class="text-gray-600 text-sm">Stock: {{ $product->stock_quantity }}</span>
        </div>
        ...
        <div class="flex justify-between items-center border-b pb-3">
            <div>
                ...
                <div class="flex items-center space-x-2 mt-1">
                    ...
                    <button onclick="updateQuantity(${item.id}, ${item.quantity + 1})"
                            class="text-gray-500 hover:text-gray-700 ${item.quantity >= item.stock ? 'opacity-50 cursor-not-allowed' : ''}"
