            ...
            <div class="form-container">
                <div class="form-header">
                    <div>
                        ...
                        <p class="form-subtitle">Create a new category for organizing your products</p>
                    </div>
                ...
                <div class="category-icon">
                    ...
                    <div>Enter the details for your new category below</div>
                </div>
                ...
                <form action="{{ route('category_management.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-with-icon">
                            <input type="text" id="name" name="name" class="form-control @error('name') is-invalid @enderror" required value="{{ old('name') }}" placeholder="Enter category name">
